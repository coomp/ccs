...
func (EnumUserSex) Descriptor() protoreflect.EnumDescriptor {
	return file_grpc_request_proto_enumTypes[0].Descriptor()
}

func (EnumUserSex) Type() protoreflect.EnumType {
	return &file_grpc_request_proto_enumTypes[0]
}
...
func (x *UserIndexResponse) Reset() {
	*x = UserIndexResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_request_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserIndexResponse) Descriptor() ([]byte, []int) {
	return file_grpc_request_proto_rawDescGZIP(), []int{2}
}
...
func (x *UserViewRequest) Reset() {
	*x = UserViewRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_request_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserViewRequest) Descriptor() ([]byte, []int) {
	return file_grpc_request_proto_rawDescGZIP(), []int{3}
}
...
func (x *UserViewResponse) Reset() {
	*x = UserViewResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_request_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserViewResponse) Descriptor() ([]byte, []int) {
	return file_grpc_request_proto_rawDescGZIP(), []int{4}
}
...
func (x *UserPostRequest) Reset() {
	*x = UserPostRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_request_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserPostRequest) Descriptor() ([]byte, []int) {
	return file_grpc_request_proto_rawDescGZIP(), []int{5}
}
...
func (x *UserPostResponse) Reset() {
	*x = UserPostResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_request_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserPostResponse) Descriptor() ([]byte, []int) {
	return file_grpc_request_proto_rawDescGZIP(), []int{6}
}
...
func (x *UserDeleteRequest) Reset() {
	*x = UserDeleteRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_request_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserDeleteRequest) Descriptor() ([]byte, []int) {
	return file_grpc_request_proto_rawDescGZIP(), []int{7}
}
...
func (x *UserDeleteResponse) Reset() {
	*x = UserDeleteResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_grpc_request_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserDeleteResponse) Descriptor() ([]byte, []int) {
	return file_grpc_request_proto_rawDescGZIP(), []int{8}
}
...
var file_grpc_request_proto_rawDesc = []byte{
	...
	,
	...
	0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x75, 0x73, 0x65,
	0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x52, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x22, 0x23, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72, 0x56, 0x69, 0x65, 0x77, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x03, 0x75, 0x69, 0x64, 0x22, 0x5c, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x56,
	0x69, 0x65, 0x77, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x65,
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x53, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72, 0x50, 0x6f, 0x73,
	...
	0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x61, 0x67, 0x65, 0x22, 0x36, 0x0a, 0x10, 0x55, 0x73,
	0x65, 0x72, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10,
	0x0a, 0x03, 0x65, 0x72, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x65, 0x72, 0x72,
	0x12, 0x10, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d,
	0x73, 0x67, 0x22, 0x25, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x75, 0x69, 0x64, 0x22, 0x38, 0x0a, 0x12, 0x55, 0x73, 0x65,
	...
	,
	...
	0x73, 0x65, 0x22, 0x00, 0x42, 0x17, 0x5a, 0x15, 0x70, 0x6b, 0x67, 0x2f, 0x73, 0x65, 0x72, 0x76,
...
var file_grpc_request_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_grpc_request_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
...
func file_grpc_request_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_grpc_request_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_grpc_request_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_grpc_request_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_grpc_request_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_grpc_request_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_grpc_request_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_grpc_request_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_grpc_request_proto_enumTypes,
